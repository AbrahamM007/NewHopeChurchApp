    ...
    <View style={styles.container}>
      ...
      <View style={styles.liveCard}>
        ...
        <TouchableOpacity style={styles.playButton}>
          <FontAwesome name="play" size={24} color="#205E82" />
        </TouchableOpacity>
      </View>
      ...
      <View style={styles.iconButtonsContainer}>
        <TouchableOpacity style={styles.iconButton}>
          <FontAwesome name="television" size={24} color="#205E82" />
        </TouchableOpacity>
        <TouchableOpacity style={styles.iconButton}>
          <FontAwesome name="book" size={24} color="#205E82" />
        </TouchableOpacity>
        <TouchableOpacity style={styles.iconButton}>
          <FontAwesome name="map-marker" size={24} color="#205E82" />
        </TouchableOpacity>
      </View>
      ...
      <TouchableOpacity style={styles.prayerButton}>
        ...
        <FontAwesome name="comment" size={20} color="#205E82" style={styles.commentIcon} />
      </TouchableOpacity>
