    ...
    <View style={styles.container}>
      ...
      <View style={styles.liveCard}>
        ...
        <TouchableOpacity style={styles.playButton}>
          <Image
            source={require('./assets/icons/Polygon 1.png')}
      ...
      <View style={styles.iconButtonsContainer}>
        <TouchableOpacity style={styles.iconButton}>
          <Image
            source={require('../assets/icons/Group 272.png')}
            style={styles.iconImage}
          />
        </TouchableOpacity>
        <TouchableOpacity style={styles.iconButton}>
          <Image
            source={require('../assets/icons/Group 273.png')}
            style={styles.iconImage}
          />
        </TouchableOpacity>
        <TouchableOpacity style={styles.iconButton}>
          <Image
            source={require('../assets/icons/Group 274.png')}
            style={styles.iconImage}
          />
        </TouchableOpacity>
      </View>
      ...
      <TouchableOpacity style={styles.prayerButton}>
        ...
        <Image
          source={require('../assets/icons/463456.png')}
          style={styles.iconImage}
        />
      </TouchableOpacity>

      {/* Bottom Navigation */}
      <BottomNavigation /> {/* Add the BottomNavigation component here */}
    </View>
  );
};
