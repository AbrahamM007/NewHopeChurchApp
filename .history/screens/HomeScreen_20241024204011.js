    ...
    <View style={styles.container}>
      ...
      <View style={styles.iconButtonsContainer}>
        <TouchableOpacity style={styles.iconButton}>
          <Image
            source={require('../assets/icons/Group 272.svg')}
            style={styles.iconImage}
          />
        </TouchableOpacity>
        <TouchableOpacity style={styles.iconButton}>
          <Image
            source={require('../assets/icons/Group 273.svg')}
            style={styles.iconImage}
          />
        </TouchableOpacity>
        <TouchableOpacity style={styles.iconButton}>
          <Image
            source={require('../assets/icons/Group 274.svg')}
            style={styles.iconImage}
          />
        </TouchableOpacity>
      </View>
      ...
      <TouchableOpacity style={styles.prayerButton}>
        ...
        <Image
          source={require('../assets/icons/463456.svg')}
          style={styles.iconImage}
        />
      </TouchableOpacity>
    </View>
